...
namespace Valderramamara5\CustomerEntities\Repository;

use Valderramamara5\CustomerEntities\Entity\Customers;
use Valderramamara5\CustomerEntities\Entity\CustomerTypes;
use Valderramamara5\CustomerEntities\Entity\IdentifierTypes;
use Doctrine\Bundle\DoctrineBundle\Repository\ServiceEntityRepository;
use Symfony\Component\HttpKernel\Exception\BadRequestHttpException;
use Doctrine\Persistence\ManagerRegistry;
use Valderramamara5\CustomerEntities\Repository\CustomerTypesRepository;
use Valderramamara5\CustomerEntities\Repository\IdentifierTypesRepository;
